...
from configs.config_ONJODE import *
...
########################################################
########### OPERATOR NEURAL JUMP MODEL DICTS ###########
########################################################
# -------- Brownian Cosine
# brownian_cos_dict = {
#     'model_name': "BrownianCosine",
#     'nb_paths': 10000, 'nb_time_steps': 50, # can increase to 20000, 100 if enough compute
#     'nb_space_steps': 50,
#     'maturity': 1., 'obs_perc': 0.1,
#     'space_limits': (-5, 5), 'space_dimension': 1,
#     'dimension': 1,
#     'J_obs_perc': 0.4
#     } # don't need model name, it is provided in the --dataset_name tag
...
#     'nb_space_steps': 100,
#     'maturity': 1., 'obs_perc': 0.1,
#     'space_limits': (0, 20), 'space_dimension': 1,
#     'dimension': 1,
#     'J_obs_perc': 0.4
# }

brownian_cos_sine_dict = {
    'model_name': "BrownianCosSine",
    'nb_paths': 20000, 'nb_time_steps': 100,
    'nb_space_steps': 100,
    'maturity': 1., 'obs_perc': 0.1,
...
brownian_cos_sum_dict = {
    'model_name': "BrownianCosSum",
    'nb_paths': 20000, 'nb_time_steps': 100,
    'nb_space_steps': 100,
    'maturity': 1., 'obs_perc': 0.1,
...
# nb_paths, nb_time_steps, nb_space_steps, maturity, space_limits, space_dimension, dimension
